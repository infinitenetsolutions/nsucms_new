                                ...
                                <div class="  mb-3">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 ">
                                            ...
                                            <select id="prospectus_course" onchange="check_semester(this.value)" name="prospectus_course_name" class="form-control" required="">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input readonly id="session" name="prospectus_session" class="form-control" value="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-4">
                                ...
                                <div class="  mb-3">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input id="prospectus_applicant_name" name="prospectus_applicant_name" class="form-control" placeholder="Enter Name" type="text" required="">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="">Father's Name</label>
                                            <input id="prospectus_fathers_name" name="prospectus_father_name" class="form-control" placeholder="Father's Name" type="text" required="">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="">Mother's Name</label>
                                            <input id="prospectus_mothers_name" name="prospectus_mother_name" class="form-control" placeholder="Mother's Name" type="text" required="">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="">Referred By</label>
                                            <input type="text" id="" name="revert_by" placeholder="Counselor Name" class="form-control" value="" required="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input id="prospectus_dob" name="prospectus_dob" class="form-control" placeholder="Enter DOB" type="date" required="">
                                        </div>


                                        <div class="form-group col-md-2">
                                            <label for="">Postal Code</label>
                                            <input onkeyup="check_pincode(this.value)" maxlength="6" id="prospectus_postal_code" name="prospectus_postal_code" class="form-control" placeholder="Enter Postal Code" type="text" required="">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="">Country</label>
                                            <input id="prospectus_country" name="prospectus_country" class="form-control" value="" type="text" readonly="">
                                        </div>
                                        <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <textarea id="prospectus_address" name="prospectus_address" class="form-control" placeholder="Enter Your Address" required=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- OTP Section Starts -->
                                ...
                                <div class="  mb-3">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input id="prospectus_email" name="prospectus_emailid" class="form-control" placeholder="Enter Email" type="email" required="">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input id="prospectus_phone" name="mobile" onkeyup="check_number(this.value)" class="form-control" placeholder="Enter Phone Number" type="text" maxlength="10" minlength="10" required="">
                                        ...
                                        <div class="form-group col-md-4" id="vaild_otp" style="display: none">
                                            <label for="">OTP</label>
                                            <input id="prospectus_otp" class="form-control" placeholder="Enter 6 Digit OTP" type="text" maxlength="6" minlength="6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mt-4">
                                            <input type="checkbox" name="" required id=""> <span style="color:#3d3c3fe8;"><b> Yes I have
                                                    read all the
                                                    instructions, by clicking the button <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal">Accept & Go</a> </span>
                                        </div>
                                    </div>
